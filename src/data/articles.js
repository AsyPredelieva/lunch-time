export const articles = [
    {
        id: 0,
        title: 'Add more fruit and vegetables to your diet',
        description: [
    ...
    {
        id: 1,
        title: 'How to increase your intake:',
        description: [
    ...
    {
        id: 2,
        title: 'Moderation: important to any healthy diet',
        description: [
    ...
    {
        id: 3,
        title: 'Plan your meals by the week or even the month',
        description: [
